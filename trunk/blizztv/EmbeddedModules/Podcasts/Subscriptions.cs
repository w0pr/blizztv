...
namespace BlizzTV.EmbeddedModules.Podcasts
{
    public sealed class Subscriptions : SubscriptionsHandler
    {
        ...
        private Subscriptions() : base(typeof(PodcastSubscription)) { }
        ...
        public Dictionary<string, PodcastSubscription> Dictionary
        {
            get
            {
                return this.List.ToDictionary(subscription => ((PodcastSubscription)subscription).Url, subscription => (subscription as PodcastSubscription));
            }
        }
    }
    ...
    [Serializable]
    [XmlType("Podcast")]
    public class PodcastSubscription : Subscription
    {
        [XmlAttribute("Url")]
