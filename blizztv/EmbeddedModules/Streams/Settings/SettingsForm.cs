...
namespace BlizzTV.EmbeddedModules.Streams.Settings
{
    public partial class SettingsForm : Form, IModuleSettingsForm
    {
        ...
        {
            var form = new CatalogBrowser(StreamsModule.Instance);
            form.ShowDialog();
            this.LoadSubscriptions();
        }
        ...
        {
            new VideoGuide("http://www.youtube.com/v/SXirg43JTlA?fs=1&autoplay=1&hl=en_US", "[Guide] How to add stream subscriptions?").Show(); 
        }
    }
