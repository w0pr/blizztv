...
namespace System.Windows.Forms.Calendar
{
    ...
    public class CalendarColorTable
    {
        ...
        /// </summary>
        public Color DayBackgroundEven = Color.White;

        /// <summary>
        /// Background color of days in odd months
        /// </summary>
        public Color DayBackgroundOdd = Color.LightYellow; // SystemColors.ControlLight;

        /// <summary>
        /// Background color of selected days
        /// </summary>
        public Color DayBackgroundSelected = SystemColors.HotTrack;

        /// <summary>
        /// Border of day
        /// </summary>
        public Color DayBorder = Color.Silver;// SystemColors.ControlDark;

        /// <summary>
        /// Background color of day headers.
        /// </summary>
        public Color DayHeaderBackground = SystemColors.Control;

        /// <summary>
        /// Color of text of day headers
        /// </summary>
        public Color DayHeaderTodayText = SystemColors.HighlightText;
        ...
        /// The DayTop is the zone of the calendar where items that lasts all or more are placed.
        /// </remarks>
        public Color DayTopBackground = SystemColors.ControlDark;
        ...
        /// </summary>
        public Color ItemBorder = Color.Silver;//  SystemColors.ControlText;

        /// <summary>
        /// Background color of items
        /// </summary>
        public Color ItemBackground = SystemColors.Info;
        ...
        /// </summary>
        public Color ItemSelectedBackground = SystemColors.Window; // Combine(SystemColors.Highlight, SystemColors.HighlightText);
        ...
        /// </summary>
        public Color WeekHeaderBackground = Combine(SystemColors.ActiveCaption, SystemColors.Control); //Combine(SystemColors.ControlDark, SystemColors.Control);
        ...
        /// </summary>
        public Color TodayBorder = SystemColors.HotTrack;  //Color.Orange;

        /// <summary>
        /// Background color of today's DayTop
        /// </summary>
        public Color TodayTopBackground = SystemColors.HotTrack;  //Color.Orange;
        ...
        /// </summary>
        public Color TimeScaleHours = SystemColors.ControlText;
        ...
        /// </summary>
        public Color TimeUnitBackground = Color.FromArgb(247, 236, 157);

        /// <summary>
        /// Background color of highlighted time units
        /// </summary>
        public Color TimeUnitHighlightedBackground = Color.LightYellow;// Combine(SystemColors.Control, SystemColors.ControlLightLight);
        ...
        /// <summary>
        /// Arrow Border color of the overflow indicators
        /// </summary>
        public Color DayOverflowBorder = Color.White;

        /// <summary>
        /// Arrow Background color of the overflow indicators
        /// </summary>
        public Color DayOverflowBackground = SystemColors.ControlText;

        /// <summary>
        /// Background color of selected overflow indicators
        /// </summary>
        public Color DayOverflowSelectedBackground = SystemColors.HotTrack;  //Color.Orange;
